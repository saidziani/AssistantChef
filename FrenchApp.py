...
import Application, SelectSpaceFr, SearchSpaceFr
...
"color: #424242;")
        ...
        self.label.setGeometry(QtCore.QRect(180, 250, 210, 210))
        self.label_2.setGeometry(QtCore.QRect(460, 250, 210, 210))
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Rechercher une\n       recette"))
        self.label_2.setText(_translate("Form", "     Rechercher une\nrecette par ingrédients"))
    ...
    def openRec(self, event):
        ...
        self.ui = SearchSpaceFr.SearchSpaceFr()
        self.ui.setupUi(self.window)
        self.window.show()

    def openIng(self, event):
        self.window = QtWidgets.QMainWindow()
        self.ui = SelectSpaceFr.SelectSpaceFr()
        self.ui.setupUi(self.window)
        self.window.show()
